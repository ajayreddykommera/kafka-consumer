package com.ajay.kafkaConsumer.configurations;

import com.ajay.kafkaConsumer.model.Person;
import com.ajay.kafkaConsumer.model.PersonDeserializer;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Person> kafkaPersonListenerContainerFactory() {
